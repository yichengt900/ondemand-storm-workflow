...
prefect agent local start --key  `cat /contrib/Soroosh.Mani/secrets/prefect.key` --label tacc-odssm-rdhpcs-schism-cluster --name tacc-odssm-agent-rdhpcs-schism-cluster --log-level INFO
