...
def main(args):
    ...
    mesh_path = EFS_MOUNT_POINT / args.mesh_file
    bbox_path = EFS_MOUNT_POINT / args.domain_bbox_file
    dt_rng_path = EFS_MOUNT_POINT / args.date_range_file
    st_loc_path = EFS_MOUNT_POINT / args.station_location_file
    out_dir = EFS_MOUNT_POINT / args.out
    nhc_track = None if args.track_file is None else EFS_MOUNT_POINT / args.track_file
    cache_path = get_main_cache_path(
        EFS_MOUNT_POINT / args.cache_dir, storm_name, storm_year
    )
